...
/mob/proc/add_filter_effects()
	if(!client) return
	var/obj/shadowcasting_plane/p3 = new
...
/obj/shadowcasting_plane
	name = "shadowcasting plane master"
	plane = SHADOWCASTING_PLANE
	render_target = "all3"

/obj/shadowcasting_plane/Initialize()
	. = ..()
...
/turf/Initialize()
	. = ..()
	if(!SSshadowcasting.initialized)
		return
...
/datum/triangle/New(param_x1,param_y1,param_x2,param_y2,param_x3,param_y3)
	x1 = param_x1
	x2 = param_x2
	x3 = param_x3
	y1 = param_y1
