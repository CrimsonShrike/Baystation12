/obj/item/gun/launcher/sealant
	...
	item_icons = list(
		slot_l_hand_str = 'icons/obj/guns/sealant_gun.dmi',
		slot_r_hand_str = 'icons/obj/guns/sealant_gun.dmi',
		slot_back_str   = 'icons/obj/guns/sealant_gun.dmi'
		)

	item_state_slots = list(
		slot_l_hand_str = "humanoid body-slot_l_hand",
		slot_r_hand_str = "humanoid body-slot_r_hand",
		slot_back_str   = "humanoid body-slot_back"
		)
...
/obj/item/gun/launcher/sealant/on_update_icon()
	overlays.Cut()
	if(loaded_tank)
		overlays += image(icon, "[item_state]-tank")
