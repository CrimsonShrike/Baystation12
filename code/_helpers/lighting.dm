//We produce mutable appearances in a single colour for both blockers and emissives.
// This allows us to have stacks of blockers and emissives, ordered based on their original layer
